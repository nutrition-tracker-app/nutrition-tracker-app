  ...
  return (
    <footer
      className={`${
        ...
        darkMode ? 'border-emerald-800' : 'border-emerald-400'
      } px-4 py-5 mt-auto w-full relative z-20`}
    >
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div className="flex flex-wrap gap-5 md:gap-6 mb-4 md:mb-0">
          ...
          {/* Github */}
          <a
            href="https://github.com/nutrition-tracker-app"
            target="_blank"
        ...
        <div
          className={`${darkMode ? 'text-slate-300' : 'text-gray-700'} text-sm`}
        >
          © {new Date().getFullYear()} Nutrition Tracker 9000. All rights
          reserved.
        </div>
      </div>
    </footer>
